...
public class Global {
    ...
    static {
        ...
        loadFromJarIntoList(playEffectType, "playEffectType.txt");
        loadFromJarIntoList(colors, "colors.txt");
        loadFromJarIntoList(status, "status.txt");
        loadFromJarIntoList(icons, "icons.txt");
        loadFromJarIntoList(communicationLines, "communication.txt");
        loadFromJarIntoList(stats, "stats.txt");
//        heroes.add("Ana");
//        heroes.add("Ashe");
//        heroes.add("Baptiste");
//        heroes.add("Bastion");
