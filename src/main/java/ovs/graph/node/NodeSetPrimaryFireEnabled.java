...
public class NodeSetPrimaryFireEnabled extends Node{
    ...
    public NodeSetPrimaryFireEnabled(Graph graph) {
        super(graph);
        setName("Set Primary Fire Enabled");
    ...
    public String getTooltip() {
        return "Enables or disables primary fire for one or more players";
    }
}
