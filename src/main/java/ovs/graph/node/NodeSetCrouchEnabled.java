...
public class NodeSetCrouchEnabled extends Node{
    ...
    public NodeSetCrouchEnabled(Graph graph) {
        super(graph);
        setName("Set Crouch Enabled");
    ...
    public String getTooltip() {
        return "Enables or disables crouch for one or more players";
    }
}
