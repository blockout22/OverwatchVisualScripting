...
public class NodeDotProduct extends Node {

    PinVar pinValue1 = new PinVar();
    PinVar pinValue2 = new PinVar();
    PinVar output = new PinVar();

    public NodeDotProduct(Graph graph) {
        super(graph);
        setName("Dot Product");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Dot Product(" + value1Data.getValue().get() + ", " + value2Data.getValue().get() + ")");
    }
    ...
    public String getTooltip() {
        return "The dot product of the specified values.";
    }
}