...
public class NodeIsFlagAtBase extends Node {

    PinVar pinTeam = new PinVar();
    PinVar output = new PinVar();

    public NodeIsFlagAtBase(Graph graph) {
        super(graph);
        setName("Is Flag At Base");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Is Flag At Base(" + teamData.getValue().get() + ")");
    }
