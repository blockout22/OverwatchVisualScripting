...
public class NodeSetSecondaryFireEnabled extends Node{
    ...
    public NodeSetSecondaryFireEnabled(Graph graph) {
        super(graph);
        setName("Set Secondary Fire Enabled");
    ...
    public String getTooltip() {
        return "Enables or disables secondary fire for one or more players";
    }
}
