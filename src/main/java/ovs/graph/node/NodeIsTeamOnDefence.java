...
public class NodeIsTeamOnDefence extends Node {

    PinVar pinTeam = new PinVar();
    PinVar output = new PinVar();

    public NodeIsTeamOnDefence(Graph graph) {
        super(graph);
        setName("Is Team On Defence");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Is Team On Defence(" + teamData.getValue().get() + ")");
    }
