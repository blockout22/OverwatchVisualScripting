...
public class NodeSetProjectileGravity extends Node{
    ...
    public NodeSetProjectileGravity(Graph graph) {
        super(graph);
        setName("Set Projectile Gravity");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Set Projectile Gravity(" + playerData.getValue().get() + ", " + percData.getValue().get() + ");");
