...
public class NodeWorkshopSettingInteger extends Node {
    ...
    public NodeWorkshopSettingInteger(Graph graph) {
        super(graph);
        setName("Workshop Setting Integer");
    ...
    public String getTooltip() {
        return "Provides the value of a new integer number setting that will appear in the workshop settings card as a slider.";
    }
}