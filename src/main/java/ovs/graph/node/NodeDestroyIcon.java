...
public class NodeDestroyIcon extends Node{

    PinVar pinEntity = new PinVar();
    PinAction output = new PinAction();

    public NodeDestroyIcon(Graph graph) {
        super(graph);
        setName("Destroy Icon");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Destroy Icon(" + entityData.getValue().get() + ");");
