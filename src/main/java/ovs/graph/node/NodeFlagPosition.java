...
public class NodeFlagPosition extends Node {

    PinVar pinTeam = new PinVar();
    PinVar output = new PinVar();

    public NodeFlagPosition(Graph graph) {
        super(graph);
        setName("Flag Position");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Flag Position(" + teamData.getValue().get() + ")");
    }
