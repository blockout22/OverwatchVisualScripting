...
public class NodeKnockbackReceived extends Node{
    PinVar pinPlayer = new PinVar();
    PinVar pinPerc = new PinVar();

    PinAction output = new PinAction();

    public NodeKnockbackReceived(Graph graph) {
        super(graph);
        setName("Set Knockback Received");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Set Knockback Received(" + playerData.getValue().get() + ", " + percData.getValue().get() + ");");
