...
public class NodeSetMeleeEnabled extends Node{
    ...
    public NodeSetMeleeEnabled(Graph graph) {
        super(graph);
        setName("Set Melee Enabled");
    ...
    public String getTooltip() {
        return "Enables or disables melee for one or more players";
    }
}
