...
public class NodeArcTangentInDegrees extends Node {

    PinVar numerator = new PinVar();
    PinVar denominator = new PinVar();
    PinVar output = new PinVar();

    public NodeArcTangentInDegrees(Graph graph) {
        super(graph);
        setName("Arctangent In Degrees");
    ...
    public void execute() {
        ...
        outputData.getValue().set("Arctangent In Degrees(" + numeratorData.getValue().get() + ", " + denominatorData.getValue().get() + ")");
    }
